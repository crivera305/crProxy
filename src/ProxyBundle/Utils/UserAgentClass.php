...
class UserAgentClass
{
    ...
    static function chooseRandomBrowserAndOS()
    {
        $frequencies = array(
            34 => array(
                89 => array('chrome', 'win'),
    ...
    static function array_random(array $array)
    {
        return $array[array_rand($array, 1)];
    }

    static function nt_version()
    {
    ...
    static function trident_version()
    {
        return rand(3, 5) . '.' . rand(0, 1);
    }

    static function osx_version()
    {
        return "10_" . rand(5, 7) . '_' . rand(0, 9);
    }

    static function chrome_version()
    {
        return rand(13, 15) . '.0.' . rand(800, 899) . '.0';
    }

    static function presto_version()
    {
        return '2.9.' . rand(160, 190);
    }

    static function presto_version2()
    {
        return rand(10, 12) . '.00';
    }

    static function firefox($arch)
    {
    ...
    static function safari($arch)
    {
        ...
        switch ($arch) {
            case 'mac':
                $osx = self::osx_version();
                return "(Macintosh; U; {proc} Mac OS X $osx rv:" . rand(2,
                    6) . ".0; {lang}) AppleWebKit/$saf (KHTML, like Gecko) Version/$ver Safari/$saf";
            //case 'iphone':
    ...
    static function iexplorer($arch)
    {
        $ie_extra = array(
            '',
     ...
     */
    static function generateUserAgent(array $lang = array('en-US'))
    {
